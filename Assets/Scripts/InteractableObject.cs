...
namespace Valve.VR.InteractionSystem.Sample
{
	...
	public class InteractableObject : MonoBehaviour
    {
        ...
        private PistolShootController _shootController;
		...
		void Awake()
		{
            ...
            _shootController = this.GetComponent<PistolShootController>();
		}
		...
		private void HandHoverUpdate( Hand hand )
		{
            ...
            //при повтроном нажатии Grip отключаем удержание предмета
            ...
            else if (isGrabEnding && !_isGrabbing)
            {
